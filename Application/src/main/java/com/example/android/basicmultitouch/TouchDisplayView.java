...
public class TouchDisplayView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mTouches.size(); i++) {
            ...
            drawCircle(canvas, id, data, COLORS);
        }
    }
    ...
    private static final float CIRCLE_RADIUS_DP = 150f;
     ...
     * @param data
     */
    protected void drawCircle(Canvas canvas, int id, TouchHistory data, int[]COLORS) {
